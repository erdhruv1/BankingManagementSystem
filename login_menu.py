...
import validate
from customer import Account,Savings,Current,Fixed_Deposit,Address
import database_admin as db_admin

def change_address(id, database):
    ch = 1
    addr = ""
...
def get_new_account(ch,id, database):
    account = None
    acc_type = None
    msg = "Enter Balance "
    term = None
...
def open_new_account(id, database):
    account = None
    print("\n --- Menu --- ")
    ...
    account = get_new_account(ch,id, database)
...
def withdraw_money(id, database):
    try:
        acc_no = int(input("Enter your account No\n"))
    except:
        print("Invalid Account No")
...
def print_statement(id, database):
    try:
        acc_no = int(input("Enter your account No\n"))
    except:
        print("Invalid Account No")
...
def transfer_money(id, database):
    try:
